...
const BlogCard = ({ name, role, company, profileImg, testimonial, index }) => {
  ...
  return (
    ...
    >
      ...
      <p className="mt-10 text-[18px] font-[500] leading-relaxed tracking-wide text-[#F6C90E]">
        {testimonial}
      </p>
      ...
      <div className="flex gap-3 sm:absolute sm:bottom-[28px] sm:left-[28px]">
        ...
        <div className="flex flex-col gap-1 pr-7">
          <h3 className="w-[176px] text-[23px] font-bold uppercase leading-[20.7px] tracking-[-0.46056px] text-[#F6C90E]">
            {abbreviateName(name)}
          </h3>
          <p className="text-sm font-[500] leading-[16px] text-[#EEEEEE]">
            {role} @ {company}
          </p>
        </div>
      </div>
