    ...
    >
        ...
        {available ? (
          <>
            ...
            >
              <FontAwesomeIcon
                icon={faGithub}
                className=" w-[20px] rounded-full bg-yellow-400 p-5 text-[20px] md:w-[25px] md:text-[24px] lg:w-[30px] lg:text-[28px]"
                data-blobity
          ...
          <div className=" flex items-center justify-center gap-4">
            ...
            <div className=" rounded-xl bg-yellow-400 px-4 py-2 md:px-5 md:py-3 lg:px-6 lg:py-4">
      ...
      >
        <AnimatedTitle
          text={name}
          className={
            "max-w-[90%] text-[40px] leading-none text-yellow-400 md:text-[44px] md:leading-none lg:max-w-[450px] lg:text-[48px] lg:leading-none"
          }
          wordSpace={"mr-[0.25em]"}
          charSpace={"-mr-[0.01em]"}
        />
        <AnimatedBody
          text={description}
          className={
            "mt-4 w-[90%] max-w-[457px] text-[16px] font-semibold text-[#EEEEEE] "
          }
        />
