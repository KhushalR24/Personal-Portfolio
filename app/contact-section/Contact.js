      ...
      <div className="mx-auto  flex w-[90%] flex-col items-center justify-center pt-10 md:pt-0">
        ...
        >
          <AnimatedWords2
            title={"Let's Talk"}
            style={
              "flex max-w-[500px] flex-col items-start text-left text-[150px] font-extrabold uppercase leading-[0.9em] text-[#F6C90E] sm:max-w-full sm:flex-row sm:items-center sm:justify-center sm:text-center sm:text-[170px] md:text-[200px] lg:text-center lg:text-[270px] xl:text-[390px]"
            }
          />
          <Image
            src={heartIcon}
        ...
        <div className="mt-20 flex w-full flex-col items-end justify-center gap-16 sm:mt-32 sm:gap-12 md:mt-40 md:flex-row md:items-start md:justify-between lg:mt-12 lg:max-w-[1440px]">
          <div className=" flex w-[350px] max-w-[90%] flex-col items-end text-right text-[14px] font-semibold uppercase text-[#F6C90E] sm:w-[350px] sm:text-[14px] md:w-[310px] md:items-start md:text-left md:text-[16px] lg:w-[420px] lg:text-[16px]">
            <AnimatedBody
              text={
          ...
          <div className="flex gap-10 text-[16px] font-bold text-[#F6C90E]  sm:gap-14 sm:text-[24px] md:gap-10 md:text-[16px] lg:gap-20 lg:text-[28px]">
            <Link href="#" target="_blank" aria-label="View GitHub Profile">
              <AnimatedTitle
                text={"GH"}
                className={
                  "text-[16px] font-bold text-[#F6C90E] sm:text-[20px] md:text-[16px] lg:text-[28px]"
                }
                wordSpace={"mr-[0.25em]"}
                charSpace={"mr-[0.01em]"}
              />
            ...
            <Link
              href="https://www.linkedin.com/in/khushal-rakholiya"
              target="_blank"
            ...
            <Link href="https://www.youtube.com/@YonkosVerse" target="_blank" aria-label="View Youtube Channel">
              <AnimatedTitle
                text={"YT"}
                className={
                  "text-[16px] font-bold text-[#F6C90E] sm:text-[20px] md:text-[16px] lg:text-[28px]"
            ...
            <Link
              href="https://www.instagram.com/_.im_khushal.2407/"
              target="_blank"
